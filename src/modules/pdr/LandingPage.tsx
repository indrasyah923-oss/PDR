          ...
          <table className="w-full table-fixed">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-center px-4 md:px-6 py-2 md:py-3 text-xs md:text-sm font-semibold bg-gray-100 text-gray-600 w-1/6">Competency</th>
                <th className="text-left px-4 md:px-6 py-2 md:py-3 text-xs md:text-sm font-semibold bg-gray-100 text-gray-600 w-1/6">Aksi</th>
              </tr>
            </thead>
          </table>
